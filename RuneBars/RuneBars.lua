            ...
            args = {
                intro = {
                    ...
                    args = {
                        ...
                        desc1 = {
                            type = "description",
                            name = L["The Rune Bar module is a replacement for the built-in original rune bars. It is currently not complete but is entirely usable."] .. " " ..
                ...
                background = {
                    ...
                    args = {
                        ...
                        desc = {
                            type = "description",
                            name = L["The background frames allows you to set an optional backdrop behind the bars. You can configure the border and background texture and color.\n\n"] ..
